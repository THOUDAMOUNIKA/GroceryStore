    ...
    public class GroceryStoreContext : DbContext
    {
        ...
        private void SeedData(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<GroceryItem>().HasData(
                ...
                new GroceryItem { Id = 9, Name = "Oranges", Description = "Juicy navel oranges", Price = 3.49m, Quantity = 80, Category = "Fruits", ImageUrl = "https://images.unsplash.com/photo-1580052614034-c55d20bfee3b?w=300" },
                ...
                new GroceryItem { Id = 13, Name = "Yogurt", Description = "Greek vanilla yogurt", Price = 1.99m, Quantity = 70, Category = "Dairy", ImageUrl = "https://images.unsplash.com/photo-1488477181946-6428a0291777?w=300" },
                ...
                new GroceryItem { Id = 15, Name = "Croissants", Description = "Buttery croissants", Price = 3.99m, Quantity = 25, Category = "Bakery", ImageUrl = "https://images.unsplash.com/photo-1549903072-7e6e0bedb7fb?w=300" },
                ...
                new GroceryItem { Id = 19, Name = "Ground Beef", Description = "Lean ground beef", Price = 7.99m, Quantity = 25, Category = "Meat", ImageUrl = "https://images.unsplash.com/photo-1603048297172-c92544798d5a?w=300" },
                ...
                new GroceryItem { Id = 23, Name = "Quinoa", Description = "Organic quinoa", Price = 7.99m, Quantity = 40, Category = "Grains", ImageUrl = "https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=300" },
                new GroceryItem { Id = 24, Name = "Oats", Description = "Rolled oats", Price = 3.99m, Quantity = 55, Category = "Grains", ImageUrl = "https://images.unsplash.com/photo-1559181567-c3190ca9959b?w=300" },
